...
export default class Exporter implements iExporter {
	...
	exportSolutionsByPieceGroup(): void {
		this.exportDataToFile(this.solutionReporter.solutionsByPieceGroup, 'src/exports/solutions-by-piece-group.json');
	}
	...
	exportUniqueSolutions(): void {
		this.exportDataToFile(this.solutionReporter.solutionsUnique, 'src/exports/solutions-unique.json');
	}
	exportPieces(): void {
