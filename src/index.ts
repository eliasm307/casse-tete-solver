...
const pieceIdGroups: PieceIdGroups = getPossiblePieceGroups(pieces);
...
const pieceGroupPatterns: PieceGroupPatterns = getPieceGroupPatterns(pieceGroupPermutations, pieces);
