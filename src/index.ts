...
const pieceIdGroups: PieceIdGroups = getPossiblePieceGroups(AVAILABLE_PIECES);

// For each group of 3 pieces, get all the permutations for the 3 available positions, and save these to the group object
const pieceGroupPermutations: PieceGroupPermutations = getPieceGroupPermutations(pieceIdGroups);
...
const pieceGroupPatterns: PieceGroupPatterns = getPieceGroupPatterns(pieceGroupPermutations, AVAILABLE_PIECES);
